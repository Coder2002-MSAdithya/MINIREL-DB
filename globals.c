...
// const int relcat_numRecs = NUM_CATS + NT_RELCAT;
// const int attrcat_numRecs = RELCAT_NUMATTRS + ATTRCAT_NUMATTRS + NT_ATTRCAT;
const int relcat_numRecs = NUM_CATS;
...
RelCatRec RelCat_rc = {RELCAT, relcat_recLength, relcat_recsPerPg, RELCAT_NUMATTRS, relcat_numRecs, relcat_numPgs};
...
//attrcat record for attrName column of attrat
